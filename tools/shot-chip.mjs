...
try {
  ...
  await page.mouse.up();
  await sleep(900);
  await page.screenshot({ path: '/root/.codebuddy/projects/workspace/2f8a7d30-9c21-4f0b-1cfe-b21be6359000/wenV2/wenV2-main-2/.verify-shots/singlechip/chip-final.png' });
  console.log('截图完成');
